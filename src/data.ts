...
export const SIGNATURE_DISHES: MenuItem[] = [
  {
    ...
    description: 'Tender tandoori chicken simmered in an rich, velvet-smooth tomato gravy enriched with genuine cashmere saffron, freshly churned white butter, and aromatic dry fenugreek.',
    price: 32,
    rating: 4.9,
...
export const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    id: 'srt-2',
    name: 'Kashmiri Paneer Tikka Elixir',
    description: 'Pristine organic paneer skewers marinated in Greek yogurt, cold-pressed mustard oil, and wild saffron.',
    price: 28,
    rating: 4.8,
    category: 'starters',
    image: 'https://images.unsplash.com/photo-1599487488170-d11ec9c172f0?auto=format&fit=crop&w=800&q=80',
  ...
  },
  {
    ...
    rating: 4.6,
    category: 'starters',
    image: 'https://images.unsplash.com/photo-1599487488170-d11ec9c172f0?auto=format&fit=crop&w=800&q=80', // Fallback with nice contrast
    isVeg: true,
    isSpicy: false
  },
  ...
  // BEVERAGES
  {
    ...
    description: 'Smooth luxury whipped yogurt integrated with sweet aromatic Alphonso mango pulp, absolute milk cream, and fine golden almond flakes.',
    price: 10,
    rating: 4.9,
    category: 'beverages',
